import HeroImage from '../assets/img/alfin.png';
                    ...
                    <div className="flex flex-wrap">
                        <div className="w-full self-center px-4 lg:w-1/2">
                            <h1 className='text-base font-semibold text-primary md:text-xl'>
                                Hallo Semua 👋, Saya <span className='block font-bold text-dark text-4xl lg:text-5xl dark:text-white'>Alfin</span>
                            </h1>
                            <h2 className='font-medium text-secondary text-lg mb-5 lg:text-2xl'>
                                Student of <span className="text-dark dark:text-white">Universita Kuningan</span>
                            </h2>
                            ...
                            <a href="#contact" className="text-base font-semibold text-white bg-primary px-8 py-3 rounded-full hover:shadow-lg hover:opacity-80 transition duration-300 ease-in-out">Hubungi Saya</a>
                        </div>
                    ...
                    <div className="flex flex-wrap">
                        ...
                        <div className="w-full px-4 lg:w-1/2">
                            ...
                            <div className="flex items-center">
                                ...
                                {/*  linkedin  */}
                                <a href="https://www.linkedin.com/in/alfin-819745255/" target="_blank"
                                    className="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white">
                                    <svg role="img" width="20" className="fill-current" viewBox="0 0 24 24"
                                        xmlns="http://www.w3.org/2000/svg">
                                ...
                                {/*  Github  */}
                                <a href="https://github.com/krefin" target="_blank"
                                    className="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white">
                                    <svg role="img" width="20" className="fill-current" viewBox="0 0 24 24"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <title>GitHub</title>
